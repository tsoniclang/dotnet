...
export interface IComExposedDetails$instance {
    GetComInterfaceEntries(count: { value: TSByRef<int> }): TSUnsafePointer<ComWrappers_ComInterfaceEntry>;
}
...
export interface IIUnknownCacheStrategy$instance {
    ...
    ConstructTableInfo(handle: RuntimeTypeHandle, interfaceDetails: IIUnknownDerivedDetails, ptr: TSUnsafePointer<void>): IIUnknownCacheStrategy_TableInfo;
    TryGetTableInfo(handle: RuntimeTypeHandle, info: { value: TSByRef<IIUnknownCacheStrategy_TableInfo> }): boolean;
...
export interface IIUnknownDerivedDetails$instance {
    ...
    readonly ManagedVirtualMethodTable: TSUnsafePointer<void>;
}
...
export interface IIUnknownStrategy$instance {
    CreateInstancePointer(unknown_: TSUnsafePointer<void>): TSUnsafePointer<void>;
    QueryInterface(instancePtr: TSUnsafePointer<void>, iid: { value: TSByRef<Guid> }, ppObj: { value: TSByRef<TSUnsafePointer<void>> }): int;
    Release(instancePtr: TSUnsafePointer<void>): int;
}
...
export class AnsiStringMarshaller_ManagedToUnmanagedIn$instance {
    ...
    toUnmanaged(): TSUnsafePointer<byte>;
...
export class ArrayMarshaller_2_ManagedToUnmanagedIn$instance<T, TUnmanagedElement extends any> {
    ...
    getPinnableReference(): TSByRef<TUnmanagedElement>;
    getUnmanagedValuesDestination(): Span_1<TUnmanagedElement>;
    toUnmanaged(): TSUnsafePointer<TUnmanagedElement>;
    static readonly BufferSize: int;
    static GetPinnableReference<T, TUnmanagedElement extends any>(array: T[]): TSByRef<T>;
}
...
export class BStrStringMarshaller_ManagedToUnmanagedIn$instance {
    free(): void;
    fromManaged(managed: string, buffer: Span_1<CLROf<byte>>): void;
    toUnmanaged(): TSUnsafePointer<ushort>;
    static readonly BufferSize: int;
}
...
export class ComVariant$instance {
    ...
    as_<T>(): T;
    dispose(): void;
    getRawDataRef<T extends any>(): TSByRef<T>;
...
export class IIUnknownCacheStrategy_TableInfo$instance {
    ...
    table: TSUnsafePointer<void>;
    thisPtr: TSUnsafePointer<void>;
}
...
export class PointerArrayMarshaller_2_ManagedToUnmanagedIn$instance<T extends any, TUnmanagedElement extends any> {
    free(): void;
    fromManaged(array: TSUnsafePointer<T>[], buffer: Span_1<TUnmanagedElement>): void;
    getManagedValuesSource(): ReadOnlySpan_1<CLROf<nint>>;
    getPinnableReference(): TSByRef<TUnmanagedElement>;
    getUnmanagedValuesDestination(): Span_1<TUnmanagedElement>;
    toUnmanaged(): TSUnsafePointer<TUnmanagedElement>;
    static readonly BufferSize: int;
    static GetPinnableReference<T extends any, TUnmanagedElement extends any>(array: TSUnsafePointer<T>[]): TSByRef<byte>;
}
...
export class ReadOnlySpanMarshaller_2_ManagedToUnmanagedIn$instance<T, TUnmanagedElement extends any> {
    ...
    toUnmanaged(): TSUnsafePointer<TUnmanagedElement>;
    static readonly BufferSize: int;
    static GetPinnableReference<T, TUnmanagedElement extends any>(managed: ReadOnlySpan_1<T>): TSByRef<T>;
}
...
export class ReadOnlySpanMarshaller_2_ManagedToUnmanagedOut$instance<T, TUnmanagedElement extends any> {
    free(): void;
    fromUnmanaged(unmanaged: TSUnsafePointer<TUnmanagedElement>): void;
...
export class SpanMarshaller_2_ManagedToUnmanagedIn$instance<T, TUnmanagedElement extends any> {
    ...
    toUnmanaged(): TSUnsafePointer<TUnmanagedElement>;
    static readonly BufferSize: int;
    static GetPinnableReference<T, TUnmanagedElement extends any>(managed: Span_1<T>): TSByRef<T>;
}
...
export class VirtualMethodTableInfo$instance {
    constructor(thisPointer: TSUnsafePointer<void>, virtualMethodTable: TSUnsafePointer<void>);
    readonly thisPointer: TSUnsafePointer<void>;
    readonly virtualMethodTable: TSUnsafePointer<void>;
    deconstruct(thisPointer: { value: TSByRef<TSUnsafePointer<void>> }, virtualMethodTable: { value: TSByRef<TSUnsafePointer<void>> }): void;
}
...
export abstract class AnsiStringMarshaller$instance {
    static ConvertToManaged(unmanaged: TSUnsafePointer<byte>): string;
    static ConvertToUnmanaged(managed: string): TSUnsafePointer<byte>;
    static Free(unmanaged: TSUnsafePointer<byte>): void;
}
...
export abstract class ArrayMarshaller_2$instance {
    static AllocateContainerForManagedElements<T, TUnmanagedElement extends any>(unmanaged: TSUnsafePointer<TUnmanagedElement>, numElements: int): T[];
    static AllocateContainerForUnmanagedElements<T, TUnmanagedElement extends any>(managed: T[], numElements: { value: TSByRef<int> }): TSUnsafePointer<TUnmanagedElement>;
    static Free<T, TUnmanagedElement extends any>(unmanaged: TSUnsafePointer<TUnmanagedElement>): void;
    ...
    static GetUnmanagedValuesDestination<T, TUnmanagedElement extends any>(unmanaged: TSUnsafePointer<TUnmanagedElement>, numElements: int): Span_1<TUnmanagedElement>;
    static GetUnmanagedValuesSource<T, TUnmanagedElement extends any>(unmanagedValue: TSUnsafePointer<TUnmanagedElement>, numElements: int): ReadOnlySpan_1<TUnmanagedElement>;
}


export abstract class BStrStringMarshaller$instance {
    static ConvertToManaged(unmanaged: TSUnsafePointer<ushort>): string;
    static ConvertToUnmanaged(managed: string): TSUnsafePointer<ushort>;
    static Free(unmanaged: TSUnsafePointer<ushort>): void;
}
...
export abstract class ComInterfaceMarshaller_1$instance {
    static ConvertToManaged<T>(unmanaged: TSUnsafePointer<void>): T;
    static ConvertToUnmanaged<T>(managed: T): TSUnsafePointer<void>;
    static Free<T>(unmanaged: TSUnsafePointer<void>): void;
}
...
export abstract class PointerArrayMarshaller_2$instance {
    static AllocateContainerForManagedElements<T extends any, TUnmanagedElement extends any>(unmanaged: TSUnsafePointer<TUnmanagedElement>, numElements: int): TSUnsafePointer<T>[];
    static AllocateContainerForUnmanagedElements<T extends any, TUnmanagedElement extends any>(managed: TSUnsafePointer<T>[], numElements: { value: TSByRef<int> }): TSUnsafePointer<TUnmanagedElement>;
    static Free<T extends any, TUnmanagedElement extends any>(unmanaged: TSUnsafePointer<TUnmanagedElement>): void;
    static GetManagedValuesDestination<T extends any, TUnmanagedElement extends any>(managed: TSUnsafePointer<T>[]): Span_1<CLROf<nint>>;
    static GetManagedValuesSource<T extends any, TUnmanagedElement extends any>(managed: TSUnsafePointer<T>[]): ReadOnlySpan_1<CLROf<nint>>;
    static GetUnmanagedValuesDestination<T extends any, TUnmanagedElement extends any>(unmanaged: TSUnsafePointer<TUnmanagedElement>, numElements: int): Span_1<TUnmanagedElement>;
    static GetUnmanagedValuesSource<T extends any, TUnmanagedElement extends any>(unmanagedValue: TSUnsafePointer<TUnmanagedElement>, numElements: int): ReadOnlySpan_1<TUnmanagedElement>;
}
...
export abstract class ReadOnlySpanMarshaller_2_UnmanagedToManagedOut$instance {
    static AllocateContainerForUnmanagedElements<T, TUnmanagedElement extends any>(managed: ReadOnlySpan_1<T>, numElements: { value: TSByRef<int> }): TSUnsafePointer<TUnmanagedElement>;
...
export abstract class SpanMarshaller_2$instance {
    static AllocateContainerForManagedElements<T, TUnmanagedElement extends any>(unmanaged: TSUnsafePointer<TUnmanagedElement>, numElements: int): Span_1<T>;
    static AllocateContainerForUnmanagedElements<T, TUnmanagedElement extends any>(managed: Span_1<T>, numElements: { value: TSByRef<int> }): TSUnsafePointer<TUnmanagedElement>;
    static Free<T, TUnmanagedElement extends any>(unmanaged: TSUnsafePointer<TUnmanagedElement>): void;
    ...
    static GetUnmanagedValuesDestination<T, TUnmanagedElement extends any>(unmanaged: TSUnsafePointer<TUnmanagedElement>, numElements: int): Span_1<TUnmanagedElement>;
    static GetUnmanagedValuesSource<T, TUnmanagedElement extends any>(unmanaged: TSUnsafePointer<TUnmanagedElement>, numElements: int): ReadOnlySpan_1<TUnmanagedElement>;
}
...
export abstract class Utf16StringMarshaller$instance {
    ...
    static ConvertToUnmanaged(managed: string): TSUnsafePointer<ushort>;
    static Free(unmanaged: TSUnsafePointer<ushort>): void;
    static GetPinnableReference(str: string): TSByRef<string>;
}
