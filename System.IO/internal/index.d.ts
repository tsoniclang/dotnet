...
// Namespace: System.IO
// Assembly: System.IO.FileSystem.AccessControl, System.IO.FileSystem.Watcher, System.Private.CoreLib, System.IO.FileSystem.DriveInfo
...
export class MemoryStream$instance extends Stream$instance {
    ...
    setLength(value: long): void;
    toArray(): byte[];
    tryGetBuffer(buffer: { value: TSByRef<ArraySegment_1<CLROf<byte>>> }): boolean;
    write(buffer: byte[], offset: int, count: int): void;
    write(buffer: ReadOnlySpan_1<CLROf<byte>>): void;
    write(buffer: ReadOnlySpan_1<CLROf<byte>>): void;
    writeAsync(buffer: byte[], offset: int, count: int, cancellationToken: CancellationToken): Task;
...
export class UnmanagedMemoryAccessor$instance {
    ...
    dispose(): void;
    read<T extends any>(position: long, structure: { value: TSByRef<T> }): void;
    ...
    write<T extends any>(position: long, structure: { value: TSByRef<T> }): void;
...
export class UnmanagedMemoryStream$instance extends Stream$instance {
    ...
    constructor(pointer: TSUnsafePointer<byte>, length: long);
    constructor(pointer: TSUnsafePointer<byte>, length: long, capacity: long, access: FileAccess);
    readonly canRead: boolean;
    readonly canSeek: boolean;
    readonly canWrite: boolean;
    readonly capacity: long;
    readonly length: long;
    position: long;
    positionPointer: TSUnsafePointer<byte>;
    dispose(): void;
    disposeAsync(): ValueTask;
    flush(): void;
    flushAsync(cancellationToken: CancellationToken): Task;
...
export abstract class Path$instance {
    ...
    static TryJoin(path1: ReadOnlySpan_1<CLROf<string>>, path2: ReadOnlySpan_1<CLROf<string>>, path3: ReadOnlySpan_1<CLROf<string>>, destination: Span_1<CLROf<string>>, charsWritten: { value: TSByRef<int> }): boolean;
    static TryJoin(path1: ReadOnlySpan_1<CLROf<string>>, path2: ReadOnlySpan_1<CLROf<string>>, destination: Span_1<CLROf<string>>, charsWritten: { value: TSByRef<int> }): boolean;
}
