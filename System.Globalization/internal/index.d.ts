...
export class CompareInfo$instance {
    ...
    IndexOf(source: ReadOnlySpan_1<CLROf<string>>, value: ReadOnlySpan_1<CLROf<string>>, options: CompareOptions, matchLength: { value: TSByRef<int> }): int;
    ...
    IsPrefix(source: ReadOnlySpan_1<CLROf<string>>, prefix: ReadOnlySpan_1<CLROf<string>>, options: CompareOptions, matchLength: { value: TSByRef<int> }): boolean;
    ...
    IsSuffix(source: ReadOnlySpan_1<CLROf<string>>, suffix: ReadOnlySpan_1<CLROf<string>>, options: CompareOptions, matchLength: { value: TSByRef<int> }): boolean;
    ...
    LastIndexOf(source: ReadOnlySpan_1<CLROf<string>>, value: ReadOnlySpan_1<CLROf<string>>, options: CompareOptions, matchLength: { value: TSByRef<int> }): int;
