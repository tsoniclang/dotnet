...
export interface JSMarshalerArgument$instance {
    ...
    toJS(value: byte[] | undefined): void;
    ...
    toJS(value: double[] | undefined): void;
    ...
    toJS(value: string | undefined): void;
    toJS(value: (string | undefined)[] | undefined): void;
    toJS(value: Exception | undefined): void;
    toJS(value: unknown | undefined): void;
    toJS(value: (unknown | undefined)[] | undefined): void;
    toJS(value: JSObject | undefined): void;
    toJS(value: (JSObject | undefined)[] | undefined): void;
    toJS(value: Task | undefined): void;
    toJS<T>(value: Task_1<T> | undefined, marshaler: JSMarshalerArgument_ArgumentToJSCallback_1<T>): void;
    toJS(value: Action | undefined): void;
    ...
    toManaged(value: byte[] | undefined): void;
    ...
    toManaged(value: int[] | undefined): void;
    ...
    toManaged(value: double[] | undefined): void;
    ...
    toManaged(value: string | undefined): void;
    toManaged(value: (string | undefined)[] | undefined): void;
    toManaged(value: Exception | undefined): void;
    toManaged(value: unknown | undefined): void;
    toManaged(value: (unknown | undefined)[] | undefined): void;
    toManaged(value: JSObject | undefined): void;
    toManaged(value: (JSObject | undefined)[] | undefined): void;
    toManaged(value: Task | undefined): void;
    toManaged<T>(value: Task_1<T> | undefined, marshaler: JSMarshalerArgument_ArgumentToManagedCallback_1<T>): void;
    toManaged(value: Action | undefined): void;
