...
export class PEMemoryBlock$instance {
    readonly length: int;
    readonly pointer: TSUnsafePointer<byte>;
...
export class PEHeaders$instance {
    ...
    tryGetDirectoryOffset(directory: DirectoryEntry, offset: { value: TSByRef<int> }): boolean;
}
...
export class PEReader$instance {
    constructor(peImage: TSUnsafePointer<byte>, size: int);
    constructor(peImage: TSUnsafePointer<byte>, size: int, isLoadedImage: boolean);
    constructor(peStream: Stream);
    ...
    tryOpenAssociatedPortablePdb(peImagePath: string, pdbFileStreamProvider: Func_2<CLROf<string>, Stream>, pdbReaderProvider: { value: TSByRef<MetadataReaderProvider> }, pdbPath: { value: TSByRef<string> }): boolean;
}
