...
export const ManagedPEBuilder: {
    new(header: PEHeaderBuilder, metadataRootBuilder: MetadataRootBuilder, ilStream: BlobBuilder, mappedFieldData: BlobBuilder | undefined, managedResources: BlobBuilder | undefined, nativeResources: ResourceSectionBuilder | undefined, debugDirectoryBuilder: DebugDirectoryBuilder | undefined, strongNameSignatureSize: int, entryPoint: MethodDefinitionHandle, flags: CorFlags, deterministicIdProvider: Func_2<IEnumerable_1<Blob>, BlobContentId> | undefined): ManagedPEBuilder;
...
export interface PEReader$instance {
    ...
    tryOpenAssociatedPortablePdb(peImagePath: string, pdbFileStreamProvider: Func_2<System_Internal.String, Stream | undefined>, pdbReaderProvider: MetadataReaderProvider | undefined, pdbPath: string | undefined): boolean;
}
