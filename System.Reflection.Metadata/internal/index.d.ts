...
// Assembly: System.Reflection.Metadata, System.Private.CoreLib
...
export class BlobReader$instance {
    constructor(buffer: TSUnsafePointer<byte>, length: int);
    readonly currentPointer: TSUnsafePointer<byte>;
    readonly length: int;
    offset: int;
    readonly remainingBytes: int;
    readonly startPointer: TSUnsafePointer<byte>;
    ...
    reset(): void;
    tryReadCompressedInteger(value: { value: TSByRef<int> }): boolean;
    tryReadCompressedSignedInteger(value: { value: TSByRef<int> }): boolean;
}
...
export class BlobWriter$instance {
    ...
    writeBytes(buffer: TSUnsafePointer<byte>, byteCount: int): void;
...
export class AssemblyNameInfo$instance {
    ...
    static TryParse(assemblyName: ReadOnlySpan_1<CLROf<string>>, result: { value: TSByRef<AssemblyNameInfo> }): boolean;
}
...
export class BlobBuilder$instance {
    ...
    writeContentTo(destination: { value: TSByRef<BlobWriter> }): void;
...
export class MetadataReader$instance {
    constructor(metadata: TSUnsafePointer<byte>, length: int);
    constructor(metadata: TSUnsafePointer<byte>, length: int, options: MetadataReaderOptions);
    constructor(metadata: TSUnsafePointer<byte>, length: int, options: MetadataReaderOptions, utf8Decoder: MetadataStringDecoder);
    ...
    readonly metadataPointer: TSUnsafePointer<byte>;
...
export class MetadataReaderProvider$instance {
    ...
    static FromMetadataImage(start: TSUnsafePointer<byte>, size: int): MetadataReaderProvider;
    ...
    static FromPortablePdbImage(start: TSUnsafePointer<byte>, size: int): MetadataReaderProvider;
...
export class TypeName$instance {
    ...
    static TryParse(typeName: ReadOnlySpan_1<CLROf<string>>, result: { value: TSByRef<TypeName> }, options?: TypeNameParseOptions): boolean;
...
export abstract class AssemblyExtensions$instance {
    static TryGetRawMetadata(assembly: Assembly, blob: { value: TSByRef<TSUnsafePointer<byte>> }, length: { value: TSByRef<int> }): boolean;
}
