...
// Assembly: System.Text.Encodings.Web, System.Private.CoreLib
...
export class Utf8_TryWriteInterpolatedStringHandler$instance {
    constructor(literalLength: int, formattedCount: int, destination: Span_1<CLROf<byte>>, shouldAppend: TSByRef<boolean>);
    constructor(literalLength: int, formattedCount: int, destination: Span_1<CLROf<byte>>, provider: IFormatProvider, shouldAppend: TSByRef<boolean>);
...
export class UnicodeRange$instance {
    ...
    readonly length: int;
    static Create(firstCharacter: string, lastCharacter: string): UnicodeRange;
}
...
export abstract class Utf8$instance {
    static FromUtf16(source: ReadOnlySpan_1<CLROf<string>>, destination: Span_1<CLROf<byte>>, charsRead: { value: TSByRef<int> }, bytesWritten: { value: TSByRef<int> }, replaceInvalidSequences?: boolean, isFinalBlock?: boolean): OperationStatus;
    static IsValid(value: ReadOnlySpan_1<CLROf<byte>>): boolean;
    static ToUtf16(source: ReadOnlySpan_1<CLROf<byte>>, destination: Span_1<CLROf<string>>, bytesRead: { value: TSByRef<int> }, charsWritten: { value: TSByRef<int> }, replaceInvalidSequences?: boolean, isFinalBlock?: boolean): OperationStatus;
    static TryWrite(destination: Span_1<CLROf<byte>>, provider: IFormatProvider, handler: { value: TSByRef<Utf8_TryWriteInterpolatedStringHandler> }, bytesWritten: { value: TSByRef<int> }): boolean;
    static TryWrite(destination: Span_1<CLROf<byte>>, handler: { value: TSByRef<Utf8_TryWriteInterpolatedStringHandler> }, bytesWritten: { value: TSByRef<int> }): boolean;
}
