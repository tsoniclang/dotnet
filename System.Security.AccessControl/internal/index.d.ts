...
// Assembly: System.IO.FileSystem.AccessControl, Microsoft.Win32.Registry, System.Threading.AccessControl, System.Security.AccessControl
...
export abstract class ObjectSecurity$instance {
    ...
    modifyAccessRule(modification: AccessControlModification, rule: AccessRule, modified: { value: TSByRef<boolean> }): boolean;
    modifyAuditRule(modification: AccessControlModification, rule: AuditRule, modified: { value: TSByRef<boolean> }): boolean;
