...
// Assembly: System.Private.Xml, System.Data.Common, System.Private.DataContractSerialization
...
export interface IXmlDictionary$instance {
    TryLookup(key: int, result: { value: TSByRef<XmlDictionaryString> }): boolean;
    TryLookup(value: string, result: { value: TSByRef<XmlDictionaryString> }): boolean;
    TryLookup(value: XmlDictionaryString, result: { value: TSByRef<XmlDictionaryString> }): boolean;
}
...
export class NameTable$instance extends XmlNameTable$instance {
    ...
    Get(key: string[], start: int, len: int): string;
}
...
export class UniqueId$instance {
    ...
    ToString(): string;
    TryGetGuid(guid: { value: TSByRef<Guid> }): boolean;
...
export class XmlBinaryWriterSession$instance {
    constructor();
    Reset(): void;
    TryAdd(value: XmlDictionaryString, key: { value: TSByRef<int> }): boolean;
}
...
export abstract class XmlDictionaryReader$instance extends XmlReader$instance {
    ...
    GetNonAtomizedNames(localName: { value: TSByRef<string> }, namespaceUri: { value: TSByRef<string> }): void;
    ...
    IsStartArray(type_: { value: TSByRef<Type> }): boolean;
    ...
    ReadContentAsQualifiedName(localName: { value: TSByRef<string> }, namespaceUri: { value: TSByRef<string> }): void;
    ...
    TryGetArrayLength(count: { value: TSByRef<int> }): boolean;
    TryGetBase64ContentLength(length: { value: TSByRef<int> }): boolean;
    TryGetLocalNameAsDictionaryString(localName: { value: TSByRef<XmlDictionaryString> }): boolean;
    TryGetNamespaceUriAsDictionaryString(namespaceUri: { value: TSByRef<XmlDictionaryString> }): boolean;
    TryGetValueAsDictionaryString(value: { value: TSByRef<XmlDictionaryString> }): boolean;
...
export abstract class XmlNameTable$instance {
    ...
    abstract Get(array: string[], offset: int, length: int): string;
    abstract Get(array: string): string;
}
