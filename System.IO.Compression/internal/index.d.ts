...
// Assembly: System.IO.Compression.ZipFile, System.IO.Compression, System.IO.Compression.Brotli
...
export class BrotliDecoder$instance {
    decompress(source: ReadOnlySpan_1<CLROf<byte>>, destination: Span_1<CLROf<byte>>, bytesConsumed: { value: TSByRef<int> }, bytesWritten: { value: TSByRef<int> }): OperationStatus;
    dispose(): void;
    static TryDecompress(source: ReadOnlySpan_1<CLROf<byte>>, destination: Span_1<CLROf<byte>>, bytesWritten: { value: TSByRef<int> }): boolean;
}
...
export class BrotliEncoder$instance {
    ...
    compress(source: ReadOnlySpan_1<CLROf<byte>>, destination: Span_1<CLROf<byte>>, bytesConsumed: { value: TSByRef<int> }, bytesWritten: { value: TSByRef<int> }, isFinalBlock: boolean): OperationStatus;
    dispose(): void;
    flush(destination: Span_1<CLROf<byte>>, bytesWritten: { value: TSByRef<int> }): OperationStatus;
    static GetMaxCompressedLength(inputSize: int): int;
    static TryCompress(source: ReadOnlySpan_1<CLROf<byte>>, destination: Span_1<CLROf<byte>>, bytesWritten: { value: TSByRef<int> }, quality: int, window: int): boolean;
    static TryCompress(source: ReadOnlySpan_1<CLROf<byte>>, destination: Span_1<CLROf<byte>>, bytesWritten: { value: TSByRef<int> }): boolean;
}
