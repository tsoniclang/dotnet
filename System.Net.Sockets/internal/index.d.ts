...
// Assembly: System.Net.Sockets, System.Net.Primitives
...
export class Socket$instance {
    ...
    beginReceive(buffer: byte[], offset: int, size: int, socketFlags: SocketFlags, errorCode: { value: TSByRef<SocketError> }, callback: AsyncCallback, state: any): IAsyncResult;
    ...
    beginReceive(buffers: IList_1<ArraySegment_1<CLROf<byte>>>, socketFlags: SocketFlags, errorCode: { value: TSByRef<SocketError> }, callback: AsyncCallback, state: any): IAsyncResult;
    beginReceiveFrom(buffer: byte[], offset: int, size: int, socketFlags: SocketFlags, remoteEP: { value: TSByRef<EndPoint> }, callback: AsyncCallback, state: any): IAsyncResult;
    beginReceiveMessageFrom(buffer: byte[], offset: int, size: int, socketFlags: SocketFlags, remoteEP: { value: TSByRef<EndPoint> }, callback: AsyncCallback, state: any): IAsyncResult;
    beginSend(buffer: byte[], offset: int, size: int, socketFlags: SocketFlags, callback: AsyncCallback, state: any): IAsyncResult;
    beginSend(buffer: byte[], offset: int, size: int, socketFlags: SocketFlags, errorCode: { value: TSByRef<SocketError> }, callback: AsyncCallback, state: any): IAsyncResult;
    ...
    beginSend(buffers: IList_1<ArraySegment_1<CLROf<byte>>>, socketFlags: SocketFlags, errorCode: { value: TSByRef<SocketError> }, callback: AsyncCallback, state: any): IAsyncResult;
    ...
    endAccept(buffer: { value: TSByRef<byte[]> }, asyncResult: IAsyncResult): Socket;
    endAccept(buffer: { value: TSByRef<byte[]> }, bytesTransferred: { value: TSByRef<int> }, asyncResult: IAsyncResult): Socket;
    ...
    endReceive(asyncResult: IAsyncResult, errorCode: { value: TSByRef<SocketError> }): int;
    endReceiveFrom(asyncResult: IAsyncResult, endPoint: { value: TSByRef<EndPoint> }): int;
    endReceiveMessageFrom(asyncResult: IAsyncResult, socketFlags: { value: TSByRef<SocketFlags> }, endPoint: { value: TSByRef<EndPoint> }, ipPacketInformation: { value: TSByRef<IPPacketInformation> }): int;
    endSend(asyncResult: IAsyncResult): int;
    endSend(asyncResult: IAsyncResult, errorCode: { value: TSByRef<SocketError> }): int;
    ...
    receive(buffer: byte[], offset: int, size: int, socketFlags: SocketFlags, errorCode: { value: TSByRef<SocketError> }): int;
    receive(buffer: Span_1<CLROf<byte>>): int;
    receive(buffer: Span_1<CLROf<byte>>, socketFlags: SocketFlags): int;
    receive(buffer: Span_1<CLROf<byte>>, socketFlags: SocketFlags, errorCode: { value: TSByRef<SocketError> }): int;
    ...
    receive(buffers: IList_1<ArraySegment_1<CLROf<byte>>>, socketFlags: SocketFlags, errorCode: { value: TSByRef<SocketError> }): int;
    ...
    receiveFrom(buffer: byte[], offset: int, size: int, socketFlags: SocketFlags, remoteEP: { value: TSByRef<EndPoint> }): int;
    receiveFrom(buffer: byte[], size: int, socketFlags: SocketFlags, remoteEP: { value: TSByRef<EndPoint> }): int;
    receiveFrom(buffer: byte[], socketFlags: SocketFlags, remoteEP: { value: TSByRef<EndPoint> }): int;
    receiveFrom(buffer: byte[], remoteEP: { value: TSByRef<EndPoint> }): int;
    receiveFrom(buffer: Span_1<CLROf<byte>>, remoteEP: { value: TSByRef<EndPoint> }): int;
    receiveFrom(buffer: Span_1<CLROf<byte>>, socketFlags: SocketFlags, remoteEP: { value: TSByRef<EndPoint> }): int;
    ...
    receiveMessageFrom(buffer: byte[], offset: int, size: int, socketFlags: { value: TSByRef<SocketFlags> }, remoteEP: { value: TSByRef<EndPoint> }, ipPacketInformation: { value: TSByRef<IPPacketInformation> }): int;
    receiveMessageFrom(buffer: Span_1<CLROf<byte>>, socketFlags: { value: TSByRef<SocketFlags> }, remoteEP: { value: TSByRef<EndPoint> }, ipPacketInformation: { value: TSByRef<IPPacketInformation> }): int;
    ...
    send(buffers: IList_1<ArraySegment_1<CLROf<byte>>>, socketFlags: SocketFlags, errorCode: { value: TSByRef<SocketError> }): int;
    send(buffer: byte[], offset: int, size: int, socketFlags: SocketFlags): int;
    send(buffer: byte[], offset: int, size: int, socketFlags: SocketFlags, errorCode: { value: TSByRef<SocketError> }): int;
    send(buffer: ReadOnlySpan_1<CLROf<byte>>): int;
    send(buffer: ReadOnlySpan_1<CLROf<byte>>, socketFlags: SocketFlags): int;
    send(buffer: ReadOnlySpan_1<CLROf<byte>>, socketFlags: SocketFlags, errorCode: { value: TSByRef<SocketError> }): int;
...
export class UdpClient$instance {
    ...
    endReceive(asyncResult: IAsyncResult, remoteEP: { value: TSByRef<IPEndPoint> }): byte[];
    endSend(asyncResult: IAsyncResult): int;
    ...
    receive(remoteEP: { value: TSByRef<IPEndPoint> }): byte[];
