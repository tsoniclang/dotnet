...
export class DbConnectionStringBuilder$instance {
    ...
    ToString(): string;
    TryGetValue(keyword: string, value: { value: TSByRef<any> }): boolean;
...
export abstract class DbProviderFactories$instance {
    ...
    static TryGetFactory(providerInvariantName: string, factory: { value: TSByRef<DbProviderFactory> }): boolean;
