...
import type { X509Certificate2, X509Certificate2Collection, X509ExtensionCollection, X509IncludeOption } from "../../System.Security.Cryptography.X509Certificates/internal/index.js";
import * as System_Security_Cryptography_Internal from "../../System.Security.Cryptography/internal/index.js";
import type { AsnEncodedData, AsymmetricAlgorithm, CompositeMLDsa, CryptographicAttributeObject, CryptographicAttributeObjectCollection, CspParameters, HashAlgorithmName, MLDsa, Oid, PbeParameters, RSA, RSAEncryptionPadding, RSASignaturePadding, SlhDsa } from "../../System.Security.Cryptography/internal/index.js";
import * as System_Internal from "../../System/internal/index.js";
import type { Array as ClrArray, Boolean as ClrBoolean, Byte, Char, DateTime, DateTimeOffset, Enum, IComparable, IConvertible, IFormatProvider, IFormattable, Int32, Int64, ISpanFormattable, Nullable_1, Object as ClrObject, ReadOnlyMemory_1, ReadOnlySpan_1, Span_1, String as ClrString, Type, TypeCode, Void } from "../../System/internal/index.js";
...
export interface __CmsRecipientCollection$views {
    As_ICollection(): System_Collections_Internal.ICollection$instance;
    As_IEnumerable(): System_Collections_Internal.IEnumerable$instance;
}

export type CmsRecipientCollection = CmsRecipientCollection$instance & __CmsRecipientCollection$views;
...
export interface __CmsRecipientEnumerator$views {
    As_IEnumerator(): System_Collections_Internal.IEnumerator$instance;
}

export type CmsRecipientEnumerator = CmsRecipientEnumerator$instance & __CmsRecipientEnumerator$views;
...
export interface __RecipientInfoCollection$views {
    As_ICollection(): System_Collections_Internal.ICollection$instance;
    As_IEnumerable(): System_Collections_Internal.IEnumerable$instance;
}

export type RecipientInfoCollection = RecipientInfoCollection$instance & __RecipientInfoCollection$views;
...
export interface __RecipientInfoEnumerator$views {
    As_IEnumerator(): System_Collections_Internal.IEnumerator$instance;
}

export type RecipientInfoEnumerator = RecipientInfoEnumerator$instance & __RecipientInfoEnumerator$views;
...
export interface __SignerInfoCollection$views {
    As_ICollection(): System_Collections_Internal.ICollection$instance;
    As_IEnumerable(): System_Collections_Internal.IEnumerable$instance;
}

export type SignerInfoCollection = SignerInfoCollection$instance & __SignerInfoCollection$views;
...
export interface __SignerInfoEnumerator$views {
    As_IEnumerator(): System_Collections_Internal.IEnumerator$instance;
}

export type SignerInfoEnumerator = SignerInfoEnumerator$instance & __SignerInfoEnumerator$views;
