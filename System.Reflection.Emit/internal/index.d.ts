...
// Assembly: System.Reflection.Emit, System.Private.CoreLib
...
export class DynamicILInfo$instance {
    ...
    setCode(code: TSUnsafePointer<byte>, codeSize: int, maxStackSize: int): void;
    setExceptions(exceptions: byte[]): void;
    setExceptions(exceptions: TSUnsafePointer<byte>, exceptionsSize: int): void;
    setLocalSignature(localSignature: byte[]): void;
    setLocalSignature(localSignature: TSUnsafePointer<byte>, signatureSize: int): void;
}
...
export class PersistedAssemblyBuilder$instance extends AssemblyBuilder$instance {
    ...
    generateMetadata(ilStream: { value: TSByRef<BlobBuilder> }, mappedFieldData: { value: TSByRef<BlobBuilder> }): MetadataBuilder;
    generateMetadata(ilStream: { value: TSByRef<BlobBuilder> }, mappedFieldData: { value: TSByRef<BlobBuilder> }, pdbBuilder: { value: TSByRef<MetadataBuilder> }): MetadataBuilder;
    getCustomAttributes(inherit: boolean): any[];
    getCustomAttributes(attributeType: Type, inherit: boolean): any[];
