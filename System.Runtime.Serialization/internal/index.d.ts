...
// Assembly: System.Runtime.Serialization.Formatters, System.Private.DataContractSerialization, System.Private.CoreLib, System.Runtime.Serialization.Primitives
...
export interface ISurrogateSelector$instance {
    ...
    GetSurrogate(type_: Type, context: StreamingContext, selector: { value: TSByRef<ISurrogateSelector> }): ISerializationSurrogate;
}
...
export abstract class DataContractResolver$instance {
    ...
    abstract TryResolveType(type_: Type, declaredType: Type, knownTypeResolver: DataContractResolver, typeName: { value: TSByRef<XmlDictionaryString> }, typeNamespace: { value: TSByRef<XmlDictionaryString> }): boolean;
}
...
export class ObjectIDGenerator$instance {
    constructor();
    GetId(obj: any, firstTime: { value: TSByRef<boolean> }): long;
    HasId(obj: any, firstTime: { value: TSByRef<boolean> }): long;
}
...
export abstract class SerializationBinder$instance {
    BindToName(serializedType: Type, assemblyName: { value: TSByRef<string> }, typeName: { value: TSByRef<string> }): void;
...
export abstract class XPathQueryGenerator$instance {
    static CreateFromDataContractSerializer(type_: Type, pathToMember: MemberInfo[], rootElementXpath: StringBuilder, namespaces: { value: TSByRef<XmlNamespaceManager> }): string;
    static CreateFromDataContractSerializer(type_: Type, pathToMember: MemberInfo[], namespaces: { value: TSByRef<XmlNamespaceManager> }): string;
}
